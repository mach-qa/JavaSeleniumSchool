    ...
    public void searchForCar() {
        ...
        for (Car filteredCar:allCars) {
            ...
            if(filteredCar.getProducer().getModel().equals("BMW") &&
                    filteredCar.isAutomaticGear() == true && filteredCar.getDimension().containsAll(sedanCars)){
                System.out.println("Your Car" + filteredCar);
                //for (int i = 0; i < 3; i++){
...
//        int counter = 0;
//        for (Car c:allCars) {
//            if (c.getProducent().equals("BMW") && c.isAutomaticGear()&& c.
//        }
//
//    }
